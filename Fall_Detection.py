...
def YOLO():
    ...
    configPath = "C:/Yolo_v4/darknet-darknet_yolo_v4_pre/build/darknet/x64/cfg/yolov4-tiny.cfg"                                 # Path to cfg
    weightPath = "C:/Yolo_v4/darknet-darknet_yolo_v4_pre/build/darknet/x64/yolov4-tiny.weights"                                 # Path to weights
    metaPath = "C:/Yolo_v4/darknet-darknet_yolo_v4_pre/build/darknet/x64/cfg/coco.data"                                         # Path to meta data
    ...
    cap = cv2.VideoCapture("Video_for_TestingHumanFall.mp4")                                # Uncomment for Local Stored video detection - Set input video
    #cap = cv2.VideoCapture("Video_for_TestingHumanFall(1).mp4")
    #cap = cv2.VideoCapture("Video_for_TestingHumanFall(2).mp4")
    #cap = cv2.VideoCapture("Video_for_TestingHumanFall(3).mp4")
    
    #url = "https://www.youtube.com/watch?v=_hafXu9xgrw"                 # Uncomment these lines for video from youtube
    #video = pafy.new(url)
