...
def YOLO():
    ...
    cap = cv2.VideoCapture("Video_for_TestingSocialDistancing.mp4")                     # Uncomment for Local Stored video detection - Set input video
    
    #url = "https://www.youtube.com/watch?v=WvhYuDvH17I"                 # Uncomment these lines for video from youtube
    #video = pafy.new(url)
