...
def YOLO():
    ...
    configPath = "C:/Yolo_v4/darknet-darknet_yolo_v4_pre/build/darknet/x64/cfg/yolov4.cfg"                                 # Path to cfg
    weightPath = "C:/Yolo_v4/darknet-darknet_yolo_v4_pre/build/darknet/x64/yolov4.weights"                                 # Path to weights
    ...
    #url = "https://www.youtube.com/watch?v=MNn9qKG2UFI&list=PLcQZGj9lFR7y5WikozDSrdk6UCtAnM9mB"            # Uncomment these lines for video from youtube
    #video = pafy.new(url)
