...
def YOLO():
    ...
    cap = cv2.VideoCapture("Video_for_Testingcrash.mp4")                                # Uncomment for Local Stored video detection - Set input video
    
    #url = "https://www.youtube.com/watch?v=CTQErltXZqM"                 # Uncomment these lines for video from youtube
    #video = pafy.new(url)
